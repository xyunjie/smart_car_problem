...
/* BING_ON 开启蜂鸣器*/
#define BING_ON gpio_set_level(C3, 1);
/* BING_OFF 关闭蜂鸣器*/
#define BING_OFF gpio_set_level(C3, 0);
/* 灰度直方图的大小*/
...
extern OutbarnStatus outbarn;
extern ChargeStatus charge;
...
/** 运行充电 */
void Run_Charge(void);
/** 运行充电错误 */
void Run_Err_Charge(void);
/** 运行出库 */
