...
#define BLUETOOTH_CH9141_INDEX              UART_3                                      // 蓝牙模块 1 对应使用的串口号
#define BLUETOOTH_CH9141_BUAD_RATE          115200                                      // 蓝牙模块 1 对应使用的串口波特率
#define BLUETOOTH_CH9141_TX_PIN             UART3_MAP0_RX_B11                           // 蓝牙模块 1 对应模块的 TX 要接到单片机的 RX
#define BLUETOOTH_CH9141_RX_PIN             UART3_MAP0_TX_B10                           // 蓝牙模块 1 对应模块的 RX 要接到单片机的 TX
#define BLUETOOTH_CH9141_RTS_PIN            E15                                          // 蓝牙模块 1 对应模块的 RTS 引脚
