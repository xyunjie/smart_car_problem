...
#else
//====================================================硬件 SPI 驱动====================================================
#define TFT180_SPI_SPEED                (72 * 1000 * 1000)/2                      // 硬件 SPI 速率
...
#define TFT180_RES_PIN                  (D8)                                    // 液晶复位引脚定义
#define TFT180_DC_PIN                   (D9)                                    // 液晶命令位引脚定义
#define TFT180_CS_PIN                   (D10)                                    // CS 片选引脚
...
#define TFT180_DEFAULT_BGCOLOR          (RGB565_BLUE)                          // 默认的背景颜色
