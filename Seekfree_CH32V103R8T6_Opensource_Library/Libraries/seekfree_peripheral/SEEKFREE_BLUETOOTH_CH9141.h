...
#define BLUETOOTH_CH9141_UART           UART_1         //无线转串口模块 所使用到的串口
#define BLUETOOTH_CH9141_UART_TX        UART1_TX_A9    //蓝牙的RX连接单片机的D16引脚
#define BLUETOOTH_CH9141_UART_RX        UART1_RX_A10    //蓝牙的TX连接单片机的D17引脚
#define BLUETOOTH_CH9141_UART_BAUD      115200

#define BLUETOOTH_CH9141_RTS_PIN        C12             //定义流控位引脚  指示当前模块是否可以接受数据  0可以继续接收  1不可以继续接收
